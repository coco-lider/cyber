    ...
    <header className="border-b fixed w-full top-0 z-40 bg-white">
      <div className="container mx-auto px-4 h-16 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex space-x-8">
          ...
          <NavLink to="/new" className="hover:text-gray-600">
            Contact Us
          </NavLink>
          <NavLink to="/brands" className="hover:text-gray-600">
            Blog
          </NavLink>
        </nav>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 lg:hidden">
          <div className="w-80 bg-white h-full">
            ...
            <nav className="p-4 space-y-4">
              <NavLink to="/shop" className="block text-lg">
                Shop
              </NavLink>
              <NavLink to="/sale" className="block text-lg">
                On Sale
              </NavLink>
              <NavLink to="/new" className="block text-lg">
                New Arrivals
              </NavLink>
              <NavLink to="/brands" className="block text-lg">
                Brands
              </NavLink>
            </nav>
          </div>
